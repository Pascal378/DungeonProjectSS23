 ...
 *
 * <p>It is possible that the ghost is just idling instead of following the hero. The ghost has a
 * chance to spawn a grave, if the grave is found by the hero he will get rewarded. (As long as the
 * ghost follows and isn't idling)
 */
public class FriendlyGhost extends Entity {
    ...
    /**
     * Setups the AI Component by determining its current state There is a 15% chance that the ghost
     * is just idling in the level *
     */
