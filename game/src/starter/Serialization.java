...
/**
 * The Highest Level state must always be saved in a file and when the game is started,
...
public class Serialization implements Serializable {
    ...
    /**
     * Constuctor*
     * @param highestScore The value from the highest level achieved,
     * then will be saved in the attribute highestScore.
     */
    ...
    /**
     * Setter
     * set the value of the highest level .
     */
